...
namespace Demo_PIG_Tool
{
    ...
    */
    public class ShellForm : Form
    {
        ...
        public ShellForm()
        {
            Text = "Personal Information Gadget";
        ...
        private void UpdateSidebarHighlight(string active)
        {
            ...
            if (active == "Home")
                ...
                btnShopping.BackColor = Color.FromArgb(0, 120, 215);       
        }
    }
}