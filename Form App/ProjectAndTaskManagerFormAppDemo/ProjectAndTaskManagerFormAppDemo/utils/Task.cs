...
namespace ProjectAndTaskManagerFormAppDemo.Utils
{
    //anh - Created a class to represent a task with its attributes and methods to update and retrieve those attributes.
